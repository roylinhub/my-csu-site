...
<script>
   function goThere() {
	   document.location.href = "ct310lec15ex03a.php";
   }
</script>
...
<div id="contents">
	...
	<p>Welcome to the home of Thing 2.</p>
	...
	<img src="ex03thing2.png" width=232 height=215 />

	<form action="#">
		<input type="button" value="Thing 1 is just as good."
			onmouseover="goThere()" />
	</form>
