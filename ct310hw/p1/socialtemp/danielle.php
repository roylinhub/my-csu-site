			...
			<div class="profile">
				...
				<div class="profilecontents">
					...
					if (isset($_SESSION['cUser'])){
						...
						//this is hardcoded for testing purposes(need to change 'danielle' later to actual user name)
						if ($_SESSION['cUser']=='danielle')
						{
							echo '<form action="danielle.php" method="post">';
