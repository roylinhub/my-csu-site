			...
			<div class="profile">
				...
				<div class="profileicon">
					...
					<?php
							...
							$picurl = file_get_contents('test4pic.txt');
						...
						if (isset($_SESSION['cUser']))
						{
							  ...
							  if ($_SESSION['cUser']=='test4')
							  {
								if(isset($_POST['p1'])){
								  $f=fopen('test4pic.txt','w');
								  fwrite($f,"./user1.png");
							   	  fclose($f);}
				...
				<div class="profilecontents">
					...
					if (isset($_SESSION['cUser'])){
						...
						//this is hardcoded for testing purposes(need to change 'test4' later to actual user name)
						if ($_SESSION['cUser']=='test4')
						{
