		...
		<div class="contents">
			<div class="profile">
				...
				<div class="profileicon">
					...
					<?php
						//only users can see the pictures
						if (isset($_SESSION['cUser']))
						{
							  //only profile can deal with changing picture
							  if ($_SESSION['cUser']=='test2')
							  {
								if(isset($_POST['p1'])){
								  $f=fopen('test2pic.txt','w');
								  fwrite($f,"./user1.png");
							   	  fclose($f);}
							...
							$picurl = file_get_contents('test2pic.txt');
				...
				<div class="profilecontents">
					...
					if (isset($_SESSION['cUser'])){
						...
						//this is hardcoded for testing purposes(need to change 'test2' later to actual user name)
						if ($_SESSION['cUser']=='test2')
						{
